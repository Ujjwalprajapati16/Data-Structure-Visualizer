...
`
  ...
  render() {
    return (
      <div className='w-full h-1/2 m-0 relative float-left border border-black'>
        <div className='w-[98.5%] h-3/100 my-1 text-xs'>import std from 'js_dsal'</div>
        <div className='w-[98.5%] h-3/100 my-1 text-xs'>const data = inputDataObject</div>
        <textarea
          ref={input => this.txtarea = input}
          className='w-[98%] h-[88%] m-1 mt-0 resize-none bg-white border-white text-xs font-sans outline-none'
          spellCheck='false'
          wrap='off'
